...
GaInP_junction = Junction(
    [
        Layer(width=120e-9, material=n_GaInP, role="Emitter",label="n_GaInP"),
        Layer(width=800e-9, material=p_GaInP, role="Base",label="p_GaInP"),
    ],
    sn=1e3,
    sp=1e3,
    T=T,
...
tunnel = TunnelJunction(
    [Layer(width=40e-9, material=n_GaInP, role="TJ",label="tunnel")],
    v_peak=0.2,
    j_peak=7.5e4,
    v_valley=1,
    j_valley=4e4,
...
my_solar_cell = SolarCell(
    [
        Layer(width=110e-9, material=MgF2, role="ARC1",label="MgF2"),
        Layer(width=60e-9, material=ZnS, role="ARC2",label="ZnS"),
        Layer(width=30e-9, material=window_top, role="window",label="window_top"),
        GaInP_junction,
        Layer(width=100e-9, material=bsf_top, role="BSF",label="bsf_top"),
        tunnel,
        GaAs_junction,
    ],
    T=T,
